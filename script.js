    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "חיו של אהוד מנור משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '0892465e-b994-4521-9e80-5577cbf2b574',
                    name: data.name || '',
                    email: data.email || '',
